...
function Footer({ userId, user, categories }) {
  ...
  return (
    <>
      {showScrollButton && (
        <button className="button-roll m-auto" onClick={scrollToTop}>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 col-12 mb-4 mb-md-0 mb-lg-0">
              ...
              <p className="mb-2">
                <strong className="d-inline me-2">Phone:</strong> 0969696969
              </p>
              <p>
            ...
            <div className="col-lg-3 col-md-6 col-12">
              <h6 className="site-footer-title mb-3 text-center">
                Truy cập nhanh
              </h6>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-7 col-md-9 col-12">
              <ul className="site-footer-links">
                ...
                <li className="site-footer-link-item">
                  <Link to="/client/about" className="site-footer-link">
                    Về chúng tôi
                  </Link>
                </li>

                <li className="site-footer-link-item">
                  <Link to="/client/contact" className="site-footer-link">
                    Liên hệ
                  </Link>
                </li>
              </ul>
